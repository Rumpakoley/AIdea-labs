      ...
      <div className="w-full flex flex-col relative z-10">
        ...
        {servicesList.map((service, i) => (
          <div
            ...
            className="group relative w-full border-b border-white/10 py-12 md:py-20 md:cursor-crosshair overflow-hidden"
          >
            ...
            {/* List Row Content */}
            <div className="relative z-20 md:z-10 max-w-[1600px] mx-auto px-6 md:px-12 flex flex-col items-start justify-between pointer-events-none">
            ...
            <div className="absolute top-1/2 left-[50%] md:left-[74%] -translate-y-1/2 -translate-x-1/2 w-56 md:w-[350px] aspect-[3/4] pointer-events-none z-10 md:z-20">
               <motion.img 
                  src={service.image}
                  animate={{
